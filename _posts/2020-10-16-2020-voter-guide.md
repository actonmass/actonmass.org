...
Massachusetts does NOT require photo ID, but you may be asked to show proof of address at the check-in table if any of the below applies to you:

-   You are voting for the first time in Massachusetts in a federal election
-   You are an inactive voter
-   You are casting a provisional or challenged ballot
-   The poll worker has a reasonable suspicion that leads them to request identification (the Secretary of State's words, not ours)
