    ...
    <main className="campaign_page">
      ...
      <section className="medium-blue cbox">
        <div className="w1000">
          ...
          <p>
            ...
            after year, policies that the <strong>majority of people in this state support</strong>{" "}
            and need in order to thrive are voted down without a public vote, or stalled
            indefinitely.
          </p>
          ...
          <p>
            ...
            popular and desperately needed legislation?
          </p>
      ...
      <section className="light-blue cbox">
        <div className="w1000">
          ...
          <p>
            There is a huge gap between what MA voters support, and what actually gets passed in our
            state house. We elect representatives to represent our interests, but the truth is, most
            of the time <strong>we don’t even know how they vote.</strong> Massachusetts has{" "}
            <a
          ...
          <ul>
            <li>
              It's difficult to know what's going on in the State House, and advocate for the bills
              we care about.
            </li>
            <li>
              Our representatives are more accountable to corporate lobbyists and the Speaker of the
              House than to their districts.
            </li>
          </ul>
      ...
      <section className="medium-blue cbox">
        <div className="w1000">
          ...
          <p>
            ...
            By activating this support to call for transparency, accountability and shared power in
            the state house rulebook, we can win a state house that truly works for all of us.
          </p>

          <p>
            We are modeling the representative democracy we’d like to see in our state by empowering
            thousands of constituents to organize their communities and meet with their
      ...
      <section className="light-blue cbox">
        <div className="w1000">
          ...
          <p>
            ...
            dozens of advocacy organizations joined our campaign for a more transparent state house.
            Largely in reaction to the power that our movement built, the Speaker of the House
            decided to delay the rules vote by six months.
          </p>
        </div>
      </section>
          ...
          <ul>
            <li>
              <a href="https://www.bostonglobe.com/2021/04/07/metro/massachusetts-lawmakers-are-debating-their-transparency-procedures-behind-closed-doors/">
                “Massachusetts lawmakers are debating their transparency procedures – behind closed
                doors”
              </a>{" "}
